...
require_once $_SERVER['DOCUMENT_ROOT'] . '/nexgen-final/assets/candidate/candidate.php';
        ...
        <tr>
          ...
          <td>
            <select name="position">
              ...
              <option value="Trainee" <?php if ($candidate->position == 'Software Engineer') echo "selected=='selected'" ?>>Software Engineer</option>
            </select>
